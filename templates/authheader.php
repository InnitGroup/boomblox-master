            	    ...
            	    <div id="Options">
            			...
            			<div id="Logo">
            			    <a id="ctl00_rbxImage_Logo" title="<?=Site::getThemeProperty("name",$theme);?>" href="/" style="display:inline-block;cursor:pointer;width:267px;height:58px;">
            			        <img src="/images/<?=Site::getThemeProperty("logo",$theme);?>" border="0" alt="<?=Site::getThemeProperty("name",$theme);?>" blankurl="http://t2.bmblox.xyz/blank-267x70.gif" style="position:relative;<?=Site::getThemeProperty("logoDimensions",$theme);?>">
            			    </a>
            			</div>
