...
exit;
$stmt = "SELECT * FROM items WHERE `itemType`='catalog' AND `catalogType`='Shirt' AND `fileName` != '' AND `itemId` > 330";
...
if ($result->rowCount() > 0) {
	...
	<Item class="Shirt" referent="RBX0">
		<Properties>
			...
			<Content name="ShirtTemplate"><url>http://'.domain.'/content/'.$shirt["itemId"].'_1.png</url></Content>
