...
$dateSent = new DateTime($invitationData["date"]);
$dateSent = $dateSent->format("n/j/Y h:i:s A");

$content = $invitationData["content"];

$username = $invitationData["senderUn"];
            ...
            <div id="InvitationPane">
                                        ...
                                        <tbody>
                                            <tr valign="top">
                                                <td style="width: 10em">
                                                    ...
                                                    <div id="Subject"> Friend Request <br>
                                                        <br>
                                                ...
                                                <td style="padding: 0 10px 0 10px">
                                                    <div class="Body">
                                                        <textarea id="ctl00_cphRoblox_rbxMessageReader_pBody" class="MultilineTextBox" style="height:250px;width:400px;overflow-y:scroll;"><?=$content?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                    </tbody>
                ...
                <div id="ctl00_cphRoblox_pSubmit_ExistingInvitation">
                    <div class="Buttons">
                        ...
                        <a id="ctl00_cphRoblox_lbDecline" class="Button" href="javascript:__doPostBack('ctl00$cphRoblox$lbDecline','')">Decline</a>
                        <a id="ctl00_cphRoblox_lbAccept" class="Button" href="javascript:__doPostBack('ctl00$cphRoblox$lbAccept','')">Accept</a>
                    </div>
                </div>
            </div>
        </div>
