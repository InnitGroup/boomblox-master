...
class Tumblr {
    ...
    public static function getNews() {
        return '
        <a href="'.Tumblr::getRelativePostLink(0).'">'.Tumblr::getRelativePostTitle(0).'</a>
        <br>
        <br>
        <br>
        <a href="'.Tumblr::getRelativePostLink(1).'">'.Tumblr::getRelativePostTitle(1).'</a>
        <br>
        <br>
        <br>
        <a href="'.Tumblr::getRelativePostLink(2).'">'.Tumblr::getRelativePostTitle(2).'</a>
        <br>
        <br>
        <br>
        ';
